...
Requires Python 3.12 or newer, uv, and Node.js 24. Clone the examples repository and enter this example's directory:

    git clone https://github.com/nabhpatodi10/blog-code-examples.git
    cd blog-code-examples/react-fastapi-background-jobs
...
This directory is the independently runnable companion for the blog post [How to Track Background Job Progress in React and FastAPI](https://nabhpatodi.com/blog/how-to-track-background-job-progress-in-react-and-fastapi/).
